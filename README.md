...
## ฟีเจอร์สำหรับทีมเซล (mock, ยังไม่มี login จริง)

- **มอบหมายแชท**: mock รายชื่อเซล 5 คนไว้ในโค้ด (`SALES_TEAM` ใน `app.py`) เลือก assign แชทแต่ละเส้นให้เซลคนไหนก็ได้จาก dropdown ในหน้าคุย เห็น badge สีในลิสต์แชทฝั่งซ้ายว่าใครดูแลอยู่
- **สลับตัวตน**: dropdown "คุณคือ:" มุมบนซ้าย ไว้จำลองว่ากำลัง login เป็นเซลคนไหน (เก็บใน browser เท่านั้น ยังไม่ใช่ auth จริง) ใช้ระบุชื่อผู้เขียนตอนบันทึกโน้ต
- **โน้ตภายใน**: แท็บ "โน้ตภายใน" แยกจากแท็บแชท บันทึกได้หลายรายการต่อแชท แต่ละรายการโชว์ผู้เขียน+วันเวลา แนบไฟล์ได้ ลูกค้าไม่เห็นข้อมูลส่วนนี้เด็ดขาด (ไม่ได้ส่งผ่าน LINE)
...
**ข้อควรระวัง**: ระบบสลับตัวตนตอนนี้เป็นแค่ dropdown ไม่มีรหัสผ่าน ใครก็สลับเป็นใครก็ได้ — เหมาะสำหรับ demo ให้ทีมดูฟีเจอร์เท่านั้น ถ้าจะใช้งานจริงต้องทำระบบ login/สิทธิ์แยกต่างหาก
